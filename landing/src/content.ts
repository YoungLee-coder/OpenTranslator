...
const zhCN: Content = {
  ...
  faq: [
    ...
    {
      q: "支持哪些模型与厂商？",
      a: "内置 OpenAI、Claude、Gemini、AIHubMix、OpenRouter、Cloudflare、DeepL。OpenAI 类型可通过 Base URL 对接兼容端点；新厂商可按注册表加 adapter。",
    },
  ],
  footer: {
...
const en: Content = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Built-in: OpenAI, Claude, Gemini, AIHubMix, OpenRouter, Cloudflare, and DeepL. Use the OpenAI type with a custom Base URL for compatible endpoints; new vendors can be added via the registry.",
    },
  ],
  footer: {
