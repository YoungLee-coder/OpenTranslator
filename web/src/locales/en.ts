...
export const en: Messages = {
  ...
  "write.shortenLevelLabel": "Degree",
  "write.shortenLight": "Light",
  "write.shortenModerate": "Moderate",
  "write.shortenAggressive": "Aggressive",
  ...
  "providers.dragHandle": "Drag to reorder \"{{name}}\"",
  "providers.reordered": "Provider order updated",
  ...
  "providers.addEndpoint": "Add API address",
  "providers.removeEndpoint": "Remove",
  "providers.endpointFormat": "API format",
  "providers.endpointN": "Address {{n}}",
  "providers.endpointsEmpty": "Add at least one API address",
  "providers.endpointNeedUrl": "Address {{n}} Base URL must start with http:// or https://",
  "providers.endpointNeedModel": "Address {{n}} needs at least one model",
  "providers.endpointDuplicate": "A model cannot appear on more than one address: {{models}}",
  "providers.format.openai": "OpenAI compatible",
  "providers.format.claude": "Claude",
  "providers.format.gemini": "Gemini",
