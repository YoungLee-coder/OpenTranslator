export const zhCN = {
  ...
  "setup.title": "服务未就绪",
  "setup.description":
    "Worker 尚未绑定运行所需的存储资源，翻译与控制台均无法使用。请在 Cloudflare Dashboard 完成绑定后重新检测。",
  "setup.missingBindings": "缺失的绑定",
  "setup.dbBinding": "D1 数据库（binding 名 DB）",
  "setup.kvBinding": "KV 命名空间（binding 名 SETTINGS_KV）",
  "setup.notConnected": "未连接",
  "setup.connected": "已连接",
  "setup.stepsTitle": "配置步骤",
  "setup.step1":
  ...
  "setup.step4": "重新部署后访问 /api/init/<JWT_SECRET> 幂等建表",
  "setup.checking": "检测中…",
  "setup.recheck": "重新检测",
